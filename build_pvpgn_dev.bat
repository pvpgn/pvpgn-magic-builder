...
:: build each project
call :build_project src\bnetd bnetd
call :build_project src\bnpass bnpass
call :build_project src\bnpass sha1hash
call :build_project src\bntrackd bntrackd
call :build_project src\bniutils bni2tga
call :build_project src\bniutils bnibuild
call :build_project src\bniutils bniextract
call :build_project src\bniutils bnilist
call :build_project src\bniutils tgainfo
call :build_project src\common common
call :build_project src\compat compat
call :build_project src\client bnbot
call :build_project src\client bnchat
call :build_project src\client bnftp
call :build_project src\client bnstat
call :build_project src\d2cs d2cs
call :build_project src\d2dbs d2dbs
call :build_project src\win32 win32
call :build_project lib\fmt fmt
