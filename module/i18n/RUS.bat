...
set PHRASE_1_0=  Visual C++ не установлен
...
set PHRASE_1_7_1=   3) Консольный [x64] (экспериментальный)
set PHRASE_1_8_1=   4) Оконный [x64] (экспериментальный)
...
set PHRASE_1_10_1=   Для PvPGN выбран консольный [x64] интерфейс
set PHRASE_1_11_1=   Для PvPGN выбран оконный [x64] интерфейс
