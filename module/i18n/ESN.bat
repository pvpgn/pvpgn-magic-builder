...
set PHRASE_1_0=  Visual C++ no está instalado
...
set PHRASE_1_7_1=   3) Consola [x64] (experimental)
set PHRASE_1_8_1=   4) Interfaz de Usuario Gráfica [x64] (experimental)
...
set PHRASE_1_10_1=   Establecer interfaz PvPGN como Consola [x64]
set PHRASE_1_11_1=   Establecer interfaz PvPGN como IUG [x64] (Interfaz de Usuario Gráfica)
set PHRASE_1_12=Seleccione un tipo de base de datos: 
set PHRASE_1_13=   1) Simple (Predeterminado)
set PHRASE_1_14=
