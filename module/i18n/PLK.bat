...
set PHRASE_1_7_1=   3) Konsola [x64] (experimental)
set PHRASE_1_8_1=   4) GUI [x64] (experimental)
set PHRASE_1_9=Podaj liczb©
set PHRASE_1_10=   Wybrany interfejs: Wiersz poleceä
set PHRASE_1_11=   Wybrany interfejs: Interfejs graficzny
set PHRASE_1_10_1=   Wybrany interfejs: Wiersz poleceä [x64]
set PHRASE_1_11_1=   Wybrany interfejs: Interfejs graficzny [x64]
set PHRASE_1_12=Wybierz typ bazy danych:
set PHRASE_1_13=   1) Pliki (domy˜lnie)
set PHRASE_1_14=
set PHRASE_1_15=   PvPGN zostanie skompilowany bez obsˆugi bazy danych
set PHRASE_1_16=Bˆ¥d podczas konfiguracji CMake

set PHRASE_2_1=Dost©pne wersje %2 (mo¾esz doda† wˆasne w katalogu %3):
set PHRASE_2_2=   Podaj liczb©
set PHRASE_2_3=   Bˆ©dny wyb¢r... spr¢buj ponownie
...
set PHRASE_2_8=    Hasˆo do bazy danych
...
set PHRASE_3_6= Aktualizacja zostaˆa anulowana przez u¾ytkownika
set PHRASE_3_6_1= Brak poˆ¥czenia z serwerem
set PHRASE_3_7=Trwa aktualizacja ...
set PHRASE_3_8= Pobieranie pliku %2 ...
set PHRASE_3_9=Aktualizacja zakoäczona
